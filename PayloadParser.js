/* Test1: 00:88:3E:50:B0:BC:02:2D:60:08:2A Port 10
   Test2: 0x 00 67 FF FF 01 BA 63
   https://support.tektelic.com/portal/api/kbArticles/274696000014617223/locale/en/attachments/0o65z953731391b004cd7bcf865214bea75e5/content?portalId=edbsn03c2c0f3d55c454c5ea69c8ffe71f7394795528efce27af0067754e2fe440f68&inline=true
*/
...
function parseUplink(device, payload) {
    ...
    // Store battery
    if (decoded.battery1_status != null && decoded.battery1_status.voltage_1 != null) {
        var sensor1 = device.endpoints.byAddress("1");

        if (sensor1 != null)
            sensor1.updateVoltageSensorStatus(decoded.battery1_status.voltage_1);
        device.updateDeviceBattery({ voltage: decoded.battery1_status.voltage_1});

    };

    // Store Location

    if (decoded.coordinates && decoded.coordinates.latitude != null && decoded.coordinates.longitude != null && decoded.coordinates.altitude != null) {
        var sensor2 = device.endpoints.byAddress("2");

        if (sensor2 != null)
            sensor2.updateLocationTrackerStatus(decoded.coordinates.latitude, decoded.coordinates.longitude, decoded.coordinates.altitude);
