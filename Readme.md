...
# Parsing Script – INDTBEU868 - Rev. B

This **Parsing** script is designed for the **INDTBEU868** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – INDTBEU868 Rev. B

Este script de **Parsing** está diseñado para el modelo **INDTBEU868** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
